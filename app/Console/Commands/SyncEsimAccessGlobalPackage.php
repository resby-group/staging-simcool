...
class SyncEsimAccessGlobalPackage extends Command
{
    ...
    protected $description = 'Sync Esim Access eSIM global packages with local database';
    ...
    public function handle()
    {
        ...
        try {
            ...
            foreach ($response->packageList as $pkg) {
                ...
                // -----------------------------------------
                // Region Mapping (Create if missing)
                // -----------------------------------------
                ...
                // Update package region & countries
